...
public class Billing_DB extends database{
    protected final String BILLING_FILE = "./Database/BillingInfo.csv";
    static ArrayList<billing_struct> BillingInfo;

    public static class billing_struct{
        public String ID;
        public String Month;
